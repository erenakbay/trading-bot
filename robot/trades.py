...
class Trade():
    ...
    def new_trade(self, trade_id: str, order_type: str, long_or_short: str, side: str, enter_or_exit: str, price: float = 0.00, stop_limit_price: float = 0.00) -> dict:
    ...
    def instrument(self, symbol: str, quantity: int, asset_type: str, sub_asset_type: str = None, order_leg_id: int = 0) -> dict:
        ...
        leg['instument']['symbol'] = symbol
        leg['instument']['assetType'] = asset_type
    ...
    def modify_side(self, side: Optional[str], order_leg_id: int = 0) -> None:
        ...
        if side and side not in ['buy', 'sell', 'sell_short', 'buy_to_cover']:
            raise ValueError('You passed the wrong side. Please use buy, sell, sell_short, or buy_to_cover')
